...
This tags defines the HTML of a banner to put at the top of the page.

=head3 <latemp_before_main_title>...</latemp_before_main_title>

This tags defines text that will come after all the layout but before the
main title. (usually an C<E<lt>h1E<gt>> tag).

=head3 <latemp_after_main_title>...</latemp_before_main_title>

This tags defines text that will come after the
...
are: "xhtml1.0-trans", "xhtml1.0-strict" and "xhtml1.1". The DOCTYPE defaults
to XHTML 1.1 Transitional if this variable is not specified.
